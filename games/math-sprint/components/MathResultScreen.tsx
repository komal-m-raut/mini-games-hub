...
import { MathRoundResult } from '../types';
...
interface MathResultScreenProps {
  result: MathRoundResult;
  nextLabel: string;
  onNext: () => void;
  onMenu: () => void;
}

/** Round-end summary: score, correct/wrong tally, Next/Menu — the same shape
 *  as ColorResultScreen and TapResultScreen. */
export function MathResultScreen({ result, nextLabel, onNext, onMenu }: MathResultScreenProps) {
  const { correct, wrong, score, rating } = result;
