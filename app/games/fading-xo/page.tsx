...
const HOW_TO_PLAY_STEPS = [
  ...
  "Win, lose or draw, the round continues until three games are played — your round score out of 10 comes from that record, and three rounds make up a solo session or a Daily/Friend Challenge.",
];
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Fading XO — Free Strategy Duel',
    description,
    url: '/games/fading-xo',
    images: [{ url: '/og.png', width: 1200, height: 630, alt: 'Fading XO' }],
  },
  twitter: {
...
export default function FadingXoPage() {
  return (
    <div className="page-container py-8 sm:py-12 flex flex-col gap-12">
      ...
      {/* How to Play */}
      <HowToPlay title="How to Play Fading XO" steps={HOW_TO_PLAY_STEPS} />
      ...
      {/* Leaderboard */}
      <section>
        <Leaderboard gameId="fading-xo" title="Fading XO — Leaderboard" />
      </section>
